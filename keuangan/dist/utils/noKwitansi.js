...
exports.generateNoKwitansi = generateNoKwitansi;
 ...
 */
async function generateNoKwitansi(client) {
    const tahun = new Date().getFullYear();
    // Ambil nilai sequence berikutnya (atomic, thread-safe di PostgreSQL)
    const result = await client.query(`SELECT nextval('seq_no_kwitansi') AS nextval`);
...
//# sourceMappingURL=noKwitansi.js.map