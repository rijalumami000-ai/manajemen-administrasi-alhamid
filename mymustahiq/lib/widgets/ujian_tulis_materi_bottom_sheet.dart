...
class UjianTulisMateriBottomSheet extends StatefulWidget {
  final int? tahunAjaranId;
  final String? semester;

  const UjianTulisMateriBottomSheet({
    super.key,
    this.tahunAjaranId,
    this.semester,
  });
  ...
  static void show(BuildContext context, {int? tahunAjaranId, String? semester}) {
    showModalBottomSheet(
      ...
      builder: (context) => UjianTulisMateriBottomSheet(
  ...
  @override
  State<UjianTulisMateriBottomSheet> createState() => _UjianTulisMateriBottomSheetState();
}

class _UjianTulisMateriBottomSheetState extends State<UjianTulisMateriBottomSheet> {
  ...
  List<dynamic> _ujianTulisMateri = [];
  ...
  Future<void> _loadMateri(int kelasId) async {
    ...
    try {
      final data = await _apiService.getMateriUjianTulis(
        kelasId: kelasId,
        tahunAjaranId: _selectedTahunAjaran?['id'],
        semester: _selectedSemester,
      );
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                color: const Color(0xFF3B82F6).withOpacity(isDark ? 0.25 : 0.2),
              ),
            ),
            child: Row(
              ...
              children: [
                ...
                Expanded(
                  child: Text(
                    "Tabel ini merupakan acuan batasan materi (Batas Awal, Batas Akhir) Ujian Tulis reguler per kelas Diniyah yang berlaku di Ponpes Al-Hamid.",
                    style: GoogleFonts.outfit(
                      fontSize: 11,
          ...
          if (_loadingFilters)
            const Padding(
              ...
              child: Center(child: LinearProgressIndicator(color: Color(0xFF3B82F6))),
            )
        ...
        child: ClipRRect(
          ...
          child: SingleChildScrollView(
            ...
            child: DataTable(
              ...
              rows: List<DataRow>.generate(_ujianTulisMateri.length, (index) {
                final item = _ujianTulisMateri[index];
