...
extension ThemeContext on BuildContext {
  ...
  Color get surfaceBg => isDarkMode ? const Color(0xFF0D1527) : const Color(0xFFE2E8F0);
  ...
  Color get borderColor => isDarkMode ? Colors.white.withOpacity(0.04) : Colors.black.withOpacity(0.06);
}
